...
class Artist(_BaseObject, _Taggable):
    ...
    def get_top_albums(self, page=1):
        ...
        doc = self._request('artist.getTopAlbums', True, params)
    ...
    def get_top_tracks(self, page=1):
        ...
        doc = self._request("artist.getTopTracks", True, params)
...
class User(_BaseObject):
    ...
    def get_friends(self, limit = 50, page=1):
        ...
        for user in doc.getElementsByTagName('user'):
            ...
            username = _extract(user, "name")
            #artist = _extract(track, "name", 1)
            #url = _extract(user, "url")
    ...
    def get_loved_tracks(self, limit=50, page=1):
        ...
        doc = self._request('user.getLovedTracks', True, params)
    ...
    def get_neighbours(self, limit = 50, page = 1):
        """Returns a list of the user's friends."""
        ...
        for user in doc.getElementsByTagName('user'):
            ...
            username = _extract(user, "name")
            url = _extract(user, "url")
            match = _extract(user, "match")
            
            seq.append((username, match))#, url))
